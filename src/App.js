  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route exact path='/invoice-add' element={<PredictionManagement/>} />
        <Route exact path='/invoice-edit' element={<RechargeManagement />} />
        <Route exact path="/new-withdraw" element={<NewWithdraw/>} />
        <Route exact path="/submitted-withdraw" element ={<SubmittedWithdraw/>} />
